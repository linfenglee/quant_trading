...
from trend_following_base import (
    State,
    MarketData,
    ModelData,
    ParameterData,
...
class TrendFollowingEngine(object):
    ...
    def fully_implicit_fdm(self, market_regime: State) -> pd.DataFrame:
        """
        ...
        for i in range(1, self.I, 1):
            ...
            f_p[i - 1] = (self.bull_mu - self.bear_mu) * i * self.dp + self.bear_mu - np.power(sigma,
                                                                                               2) / 2 - self.rho
    ...
    def penalty_method(self, market_regime: State) -> pd.DataFrame:
        """
        Penalty Method
        """
    ...
    def get_boundaries(self, bs_data: pd.DataFrame) -> BoundaryData:
        """"""
    ...
    @staticmethod
    def bs_plot(bs_data: pd.DataFrame) -> None:
        """
